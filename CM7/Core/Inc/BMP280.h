...
#define BMP280_I2C_ADDRESS_0  0x76 //0xEC
#define BMP280_I2C_ADDRESS_1  0x77 //0xEE
...
/**
 * Set I2C address of BMP280 and pointer of I2C handler in the dev.
 * Return true.
 */
...
//bool read_byte(BMP280_HandleTypedef *dev, uint8_t addr, uint8_t *value, uint8_t len);
//bool bmp280_init_(BMP280_HandleTypedef *dev, bmp280_params_t *params);
